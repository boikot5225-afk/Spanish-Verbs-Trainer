 ...
 * reçois, êtes, mangeâmes. Но набирать аксаны на телефонной клавиатуре
 * неудобно, поэтому строгость выбирает сам пользователь.
 */
...
export const ACCENT_MODE_HINTS: Record<AccentMode, string> = {
  strict: 'Ответ без нужного аксана или седили считается ошибкой',
