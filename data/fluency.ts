...
/** Меньше этого числа ответов — рано считать форму отработанной. */
export const MIN_ANSWERS = 10;
/** Порог, с которого форма считается отработанной. */
...
export interface Fluency {
  /** Итоговый показатель тренировки, 0..100. */
  score: number;
...
/**
 * Прогресс по форме — это не просто доля верных ответов. Показатель складывается из
