...
export const LESSONS: Lesson[] = [
  ...
  },
  {
    ...
    practice: {
      // Тема про выбор между hay и está, а не про спряжение: наполнители,
      // добиравшие зачёт, убраны. hay задаётся явно — это безличная форма,
      // в таблице лиц haber её нет (he, has, ha…), и она одна на любое число.
      tenses: [],
      verbIds: ['haber', 'estar'],
      featured: ['haber', 'estar'],
      cloze: [
        { verbId: 'haber', person: 'el', text: 'En la plaza ___ un banco.', translation: 'На площади есть банк.', reason: 'новое, неопределённое', answer: 'hay' },
        { verbId: 'estar', person: 'el', text: 'El banco ___ en la plaza.', translation: 'Тот самый банк на площади.', reason: 'известное, где находится' },
        { verbId: 'haber', person: 'el', text: '___ mucha gente en la calle.', translation: 'На улице много народу.', reason: 'количество, неопределённое', answer: 'hay' },
        { verbId: 'estar', person: 'ellos', text: 'Mis llaves ___ en la mesa.', translation: 'Мои ключи на столе.', reason: 'известное, где находится' },
        { verbId: 'haber', person: 'el', text: 'En esta ciudad ___ tres museos.', translation: 'В этом городе три музея.', reason: 'hay не меняется во множественном', answer: 'hay' },
        { verbId: 'estar', person: 'el', text: 'El museo ___ cerca de aquí.', translation: 'Музей недалеко отсюда.', reason: 'известное, где находится' },
        { verbId: 'haber', person: 'el', text: '___ un problema con el coche.', translation: 'Есть проблема с машиной.', reason: 'вводим новое', answer: 'hay' },
        { verbId: 'estar', person: 'el', text: 'El coche ___ en el garaje.', translation: 'Машина в гараже.', reason: 'известное, где находится' },
        { verbId: 'haber', person: 'el', text: '¿___ leche en la nevera?', translation: 'В холодильнике есть молоко?', reason: 'наличие', answer: 'hay' },
        { verbId: 'estar', person: 'el', text: 'La leche ___ en la nevera.', translation: 'Молоко в холодильнике.', reason: 'известное, где находится' },
        { verbId: 'haber', person: 'el', text: 'En mi barrio ___ dos farmacias.', translation: 'В моём районе две аптеки.', reason: 'hay одна форма на любое число', answer: 'hay' },
        { verbId: 'estar', person: 'ellos', text: 'Las farmacias ___ abiertas.', translation: 'Аптеки открыты.', reason: 'состояние известного' },
        { verbId: 'haber', person: 'el', text: 'No ___ nadie en casa.', translation: 'Дома никого нет.', reason: 'отрицание наличия', answer: 'hay' },
        { verbId: 'estar', person: 'yo', text: 'Yo ___ en casa.', translation: 'Я дома.', reason: 'где нахожусь' },
        { verbId: 'haber', person: 'el', text: '___ veinte alumnos en la clase.', translation: 'В классе двадцать учеников.', reason: 'hay, а не «hayn»', answer: 'hay' },
        { verbId: 'estar', person: 'ellos', text: 'Los alumnos ___ en el aula.', translation: 'Ученики в аудитории.', reason: 'известные, где находятся' },
        { verbId: 'haber', person: 'el', text: '¿Qué ___ para comer?', translation: 'Что есть поесть?', reason: 'наличие', answer: 'hay' },
        { verbId: 'estar', person: 'el', text: 'La comida ___ en la mesa.', translation: 'Еда на столе.', reason: 'известное, где находится' },
        { verbId: 'haber', person: 'el', text: 'Aquí ___ mucho ruido.', translation: 'Здесь много шума.', reason: 'неопределённое количество', answer: 'hay' },
        { verbId: 'estar', person: 'nosotros', text: 'Nosotros ___ en el centro.', translation: 'Мы в центре.', reason: 'где находимся' },
        { verbId: 'haber', person: 'el', text: 'En el pueblo ___ una iglesia antigua.', translation: 'В деревне есть старая церковь.', reason: 'вводим новое', answer: 'hay' },
        { verbId: 'estar', person: 'el', text: 'La iglesia ___ en el centro del pueblo.', translation: 'Церковь в центре деревни.', reason: 'известное, где находится' },
        { verbId: 'haber', person: 'el', text: '___ algo raro en esta historia.', translation: 'В этой истории есть что-то странное.', reason: 'неопределённое', answer: 'hay' },
        { verbId: 'estar', person: 'tu', text: '¿Dónde ___ tú ahora?', translation: 'Ты сейчас где?', reason: 'где находишься' },
        { verbId: 'haber', person: 'el', text: 'En la nevera ___ tres huevos.', translation: 'В холодильнике три яйца.', reason: 'hay не согласуется с числом', answer: 'hay' },
        { verbId: 'estar', person: 'ellos', text: 'Los huevos ___ en la nevera.', translation: 'Яйца в холодильнике.', reason: 'известные, где находятся' },
        { verbId: 'haber', person: 'el', text: '¿___ un banco por aquí cerca?', translation: 'Тут рядом есть банк?', reason: 'ищем неизвестное', answer: 'hay' },
        { verbId: 'estar', person: 'vosotros', text: 'Vosotros ___ muy lejos.', translation: 'Вы очень далеко.', reason: 'где находитесь' },
        { verbId: 'haber', person: 'el', text: 'Hoy ___ una fiesta en el barrio.', translation: 'Сегодня в районе праздник.', reason: 'вводим событие', answer: 'hay' },
        { verbId: 'estar', person: 'el', text: 'La fiesta ___ en la plaza.', translation: 'Праздник на площади.', reason: 'известное, где проходит' },
        { verbId: 'haber', person: 'el', text: 'No ___ tiempo para eso.', translation: 'На это нет времени.', reason: 'отрицание наличия', answer: 'hay' },
        { verbId: 'estar', person: 'ellos', text: 'Mis padres ___ en el trabajo.', translation: 'Мои родители на работе.', reason: 'известные, где находятся' },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    practice: {
      // Знать факт против быть знакомым — выбор, а не парадигма.
      tenses: [],
      verbIds: ['saber', 'conocer'],
      featured: ['saber', 'conocer'],
      cloze: [
        { verbId: 'saber', person: 'yo', text: 'Yo ___ la respuesta.', translation: 'Я знаю ответ.', reason: 'факт' },
        { verbId: 'conocer', person: 'yo', text: 'Yo ___ a María.', translation: 'Я знаю Марию.', reason: 'знакомство с человеком' },
        { verbId: 'saber', person: 'tu', text: '¿___ tú dónde está la estación?', translation: 'Ты знаешь, где вокзал?', reason: 'сведения' },
        { verbId: 'conocer', person: 'nosotros', text: 'Nosotros ___ Madrid muy bien.', translation: 'Мы хорошо знаем Мадрид.', reason: 'знакомство с местом' },
        { verbId: 'saber', person: 'el', text: 'Ella ___ nadar.', translation: 'Она умеет плавать.', reason: 'умение, saber + инфинитив' },
        { verbId: 'conocer', person: 'vosotros', text: '¿___ vosotros este restaurante?', translation: 'Вы знаете этот ресторан?', reason: 'знакомство с местом' },
        { verbId: 'saber', person: 'nosotros', text: 'Nosotros no ___ su nombre.', translation: 'Мы не знаем его имени.', reason: 'факт' },
        { verbId: 'conocer', person: 'ellos', text: 'Ellos ___ a mis padres.', translation: 'Они знают моих родителей.', reason: 'знакомство с людьми' },
        { verbId: 'saber', person: 'yo', text: 'No ___ qué hacer.', translation: 'Не знаю, что делать.', reason: 'сведения' },
        { verbId: 'conocer', person: 'tu', text: '¿___ tú al nuevo profesor?', translation: 'Ты знаешь нового преподавателя?', reason: 'знакомство с человеком' },
        { verbId: 'saber', person: 'ellos', text: 'Los niños ya ___ leer.', translation: 'Дети уже умеют читать.', reason: 'умение, saber + инфинитив' },
        { verbId: 'conocer', person: 'el', text: 'Mi hermano ___ bien esta ciudad.', translation: 'Мой брат хорошо знает этот город.', reason: 'знакомство с местом' },
        { verbId: 'saber', person: 'el', text: 'Nadie ___ la verdad.', translation: 'Никто не знает правды.', reason: 'факт' },
        { verbId: 'conocer', person: 'yo', text: '___ un buen sitio para cenar.', translation: 'Я знаю хорошее место поужинать.', reason: 'знакомство с местом' },
        { verbId: 'saber', person: 'vosotros', text: '¿___ vosotros la hora?', translation: 'Вы знаете, который час?', reason: 'сведения' },
        { verbId: 'conocer', person: 'nosotros', text: 'No ___ a nadie aquí.', translation: 'Мы тут никого не знаем.', reason: 'знакомство с людьми' },
        { verbId: 'saber', person: 'tu', text: 'Tú ___ hablar español.', translation: 'Ты умеешь говорить по-испански.', reason: 'умение, saber + инфинитив' },
        { verbId: 'conocer', person: 'ellos', text: 'Ellos ___ esa canción.', translation: 'Они знают эту песню.', reason: 'знакомы с ней' },
        { verbId: 'saber', person: 'yo', text: 'Yo ___ que él tiene razón.', translation: 'Я знаю, что он прав.', reason: 'факт' },
        { verbId: 'conocer', person: 'el', text: '¿Tu madre ___ a mi hermana?', translation: 'Твоя мама знает мою сестру?', reason: 'знакомство с человеком' },
        { verbId: 'saber', person: 'nosotros', text: '___ dónde vive.', translation: 'Мы знаем, где он живёт.', reason: 'сведения' },
        { verbId: 'conocer', person: 'tu', text: '¿___ tú Barcelona?', translation: 'Ты знаешь Барселону?', reason: 'знакомство с местом' },
        { verbId: 'saber', person: 'el', text: 'Mi padre ___ arreglar coches.', translation: 'Мой отец умеет чинить машины.', reason: 'умение, saber + инфинитив' },
        { verbId: 'conocer', person: 'vosotros', text: 'Vosotros ___ bien el museo.', translation: 'Вы хорошо знаете этот музей.', reason: 'знакомство с местом' },
        { verbId: 'saber', person: 'ellos', text: 'Ellos no ___ nada del asunto.', translation: 'Они ничего не знают об этом деле.', reason: 'факт' },
        { verbId: 'conocer', person: 'yo', text: 'Yo ___ a su familia.', translation: 'Я знаю его семью.', reason: 'знакомство с людьми' },
        { verbId: 'saber', person: 'tu', text: '¿___ tú el resultado?', translation: 'Ты знаешь результат?', reason: 'факт' },
        { verbId: 'conocer', person: 'el', text: 'El guía ___ cada calle.', translation: 'Гид знает каждую улицу.', reason: 'знакомство с местом' },
        { verbId: 'saber', person: 'vosotros', text: 'No ___ lo que pasó.', translation: 'Вы не знаете, что случилось.', reason: 'сведения' },
        { verbId: 'conocer', person: 'ellos', text: 'Mis amigos ___ ese bar.', translation: 'Мои друзья знают тот бар.', reason: 'знакомство с местом' },
        { verbId: 'saber', person: 'nosotros', text: 'Nosotros ___ cocinar paella.', translation: 'Мы умеем готовить паэлью.', reason: 'умение, saber + инфинитив' },
        { verbId: 'conocer', person: 'nosotros', text: '___ a tu profesor desde hace años.', translation: 'Мы знаем твоего преподавателя много лет.', reason: 'знакомство с человеком' },
      ],
    },
  },
  {
