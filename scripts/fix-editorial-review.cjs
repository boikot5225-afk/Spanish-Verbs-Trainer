...
edit('data/lessons.ts', source => {
  ...
  source = source.replaceAll("heading: 'Орфография догоняет'", "heading: 'Орфографические изменения'");
  return source;
});

console.log('Removed remaining ahead-of-syllabus and awkward wording.');
